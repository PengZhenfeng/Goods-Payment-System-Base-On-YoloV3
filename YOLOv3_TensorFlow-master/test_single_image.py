...
with tf.Session() as sess:
    ...
    boxes, scores, labels = gpu_nms(pred_boxes, pred_scores, args.num_class, max_boxes=30, score_thresh=0.1, iou_thresh=0.5)
    ...
    print(labels_)
#change by luomei
    output_object = './../workdir/object.json'
    with open(output_object, 'w') as c_obj:
        json.dump((str(labels_)), c_obj)
...
#    cv2.imshow('Detection result', img_ori)
    ...
    cv2.imwrite('./../workdir/object_result.jpg',img_ori)
    #remove next one
#    cv2.waitKey(0)
